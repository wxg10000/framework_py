...
class ConfFixture(object):
    ...
    CONSOLE_LOGIN_URL = str(settings.BK_PAAS_HOST)
    LOGIN_URL = str(settings.BK_PAAS_HOST) + '/login/'
    LOGIN_PLAIN_URL = str(settings.BK_PAAS_HOST) + '/login/'
    VERIFY_URL = str(settings.BK_PAAS_INNER_HOST) + '/login/accounts/is_login/'
    USER_INFO_URL = str(settings.BK_PAAS_INNER_HOST) + '/login/accounts/get_user/'
    HAS_PLAIN = False
